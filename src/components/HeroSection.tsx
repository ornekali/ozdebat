      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/devis"
              className="inline-flex items-center justify-center gap-2 bg-secondary text-white px-7 py-3.5 rounded-lg text-base font-semibold transition-all hover:bg-secondary/90 active:scale-[0.98] group"
            >
              Demander un Devis
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm text-white px-7 py-3.5 rounded-lg text-base font-medium transition-all hover:bg-white/20 border border-white/20"
            >
          ...
          {heroSlides.map((_, index) => (
            <button
              ...
              className={`h-1 rounded-full transition-all duration-300 ${
                index === currentSlide ? 'w-8 bg-secondary' : 'w-4 bg-white/30 hover:bg-white/50'
              }`}
            />
          ))}
        </div>
