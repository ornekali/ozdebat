  ...
  return (
    <>
      ...
      <section className="relative py-32 bg-primary overflow-hidden">
        <Image
          src="/images/construction-maison-piscine.jpg"
          alt=""
          fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold text-white mt-2 mb-6">
            Nos <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-accent">Réalisations</span>
          </h1>
